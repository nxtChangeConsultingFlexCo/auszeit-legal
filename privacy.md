...
Since we do not process any personal data of yours, there is nothing with us that we could
disclose, correct or delete. You delete your data in the app yourself by removing entries or
deleting the app.

Should we ever process personal data, for example because you e-mail us, you have the rights under
the GDPR: access, rectification, erasure, restriction, data portability and objection. We keep
e-mails you send us for as long as answering them requires. Complaints can be lodged with the
Austrian Data Protection Authority: https://www.dsb.gv.at

## Changes

If the app changes in a way that affects this policy, we update it. The current version is always
